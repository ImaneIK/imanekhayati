...
export default function Root({ projects }) {
  ...
  return (
    <div>
      ...
      <div className="mx-auto flex flex-col gap-[4vh] items-center px-6 md:px-[10vh]">
        ...
        <div className=' py-6 md:mx-8 md:p-0 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3  gap-[5vh]'>
                {projects.map((project,index) => (
                     <Card key={project.slug || index} url={project.resources[1]}  title={project.title} description={project.description} link={project.slug} thumbnail={project.thumbnail}/>
                ))}
        </div>
