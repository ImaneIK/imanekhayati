...
const ProjectPage = ({card}) => {
  ...
  return (
    <div className='pb-24 md:pb-0'>
      ...
      {/* sidebar */}
      <div  className='invisible md:visible  w-[8vh] fixed flex flex-col justify-between p-[2vh] h-full border-r border-gray-800'>
        <div className=" mb-10">
            <a className=' font-semibold text-[2vh]' href="/"><p className="font-extrabold text-[3vh]">IK</p>
        ...
        <div className="mb-[2vh] ">
            <div  className="my-[2vh]"> <Toggle/> </div>
            <a href="/#contact">
              <span>
        ...
        {/* header & content */}
        <div  className='w-17/18 md:pl-[9vh] flex flex-col flex-1 gap-[2vh]'>
          {/* header */}
          <div className='relative h-full w-full'>
              ...
              <div  className="mx-auto px-[3vh] py-[2vh] sm:px-6 lg:px-[4vh]">
                {/* this is hidden */}
                <div className="flex flex-col md:flex-row hidden items-center md:justify-between md:gap-4">
                  <div className="relative hidden sm:block">
                    ...
                    <input
                      className="h-[5vh] w-full rounded-lg border-none bg-white pe-10 ps-4 text-sm shadow-sm sm:w-56"
                      id="search"
                      type="search"
                      placeholder="Search ..."
                    />
                    ...
                    <button
                      type="button"
                      className="absolute end-1 top-1/2 -translate-y-1/2 rounded-md bg-gray-50 p-[2vh] text-gray-600 transition hover:text-gray-700"
                    >
                  ...
                  >
                    ...
                    >
                      ...
                      <img
                        ...
                        className="h-[5vh] w-[5vh] rounded-full object-cover"
                      /> 
                ...
                <div className="mt-[5vh]">
                  ...
                  <h1 className="text-[4vh] font-bold text-gray-100 ">
                  {card.title}
                  </h1>

                  <p className="mt-[1.5vh] text-[2vh] text-gray-100">
                    {card.description}
                  </p>
                </div>
              </div>
            ...
            {/* content */}
          <div className='flex flex-col md:flex-row gap-[2vh] p-[2vh]'>
            
            <div className='flex flex-col gap-[2vh] md:w-2/3 '>
              ...
              {/* description */}
                ...
                >
                  ...
                  <h2 className="mt-4 text-[3vh] font-bold ">Description</h2>
                  <p className="mt-1 text-[2vh] ">{card.excerpt}</p>
                </div>
              
                <div className='flex flex-col lg:flex-row gap-[2vh] w-full justify-center'>
                
                {/* scope */}
                <div className=" block rounded-xl border border-gray-800 p-[3vh] shadow-xl transition " >
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="h-[5vh] w-[5vh] "
                        fill="none"
                    ...
                    <h2 className="mt-4 text-[3vh] font-bold">Scope</h2>
                    <p className="mt-1 text-[2vh] ">{card.scope}</p>
                </div>
                ...
                <div className="block rounded-xl border border-gray-800 p-[3vh] shadow-xl transition " >
                  ...
                  <h2 className="mt-4 text-[3vh] font-bold ">Role</h2>
                  <p className="mt-1 text-[2vh] ">{card.role}</p>
                </div>
                ...
                <div className="w-full block rounded-xl border border-gray-800 p-[3vh] shadow-xl transition " >
                  <svg
                    ...
                    <h2 className="mt-4 text-[3vh] font-bold ">Persona</h2>
                    {card.persona.map((persona, index) => (
                      <li className='text-[2vh] ' key={index}>{persona}</li>
                    ))}
             
                </div>
                
                {/* UI interfaces */}
                {/* <div className=" flex flex-col w-full h-content block rounded-xl border border-gray-800 p-[3vh] shadow-xl transition hover:border-indigo-500/10 hover:shadow-indigo-500/10" >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            className="h-10 w-10 "
                            fill="none"
                ...
                <div className="w-full max-h-content h-content flex flex-col gap-[3vh] block rounded-xl border border-gray-800 p-[3vh] shadow-xl transition " >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="h-[5vh] w-[5vh] "
                        fill="none"
                      ...
                      {/* 10/20 */}
                      <h2 className="mt-4 text-[3vh] font-bold">UI interfaces</h2>
  ...
  // width:"70%", height:"auto"
            ...
            <div className=' flex flex-col gap-4 md:w-1/3 '>
                ...
                <div className="w-full block rounded-xl border border-gray-800 p-[3vh] shadow-xl transition " >
                  ...
                  <h2 className="mt-4 text-[3vh] font-bold ">Technologies & tools</h2>
                  <ul className="mt-1 grid grid-cols-3 md:grid-cols-2 lg:grid-cols-3 gap-2 text-[2vh] text-justify">
                  {card.technologies.map((technology, index) => (
                        <li key={index} className='block p-[1vh] border border-gray-700 text-center rounded-md'>{technology}</li>
                    ))}
                ...
                <div className="w-full block rounded-xl border border-gray-800 p-[3vh] shadow-xl transition " >
                    ...
                    <h2 className="mt-4 text-[3vh] font-bold ">Links & ressources</h2>
                    
                    {card.resources.map((link, index) => (
                      
                        <Link key={link || index} href={link} className="mt-1 text-[2vh] block">{link}</Link> 
