...
async function sendEmail(req, res) {
  try {
    await sendgrid.send({
      to: "imaneik007@gmail.com", // Your email where you'll receive emails
      from: "imanekhayati@outlook.fr", // your website email address here
      subject: `workfolio message : ${req.body.subject}`,
