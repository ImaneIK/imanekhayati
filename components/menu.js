    ...
    return(
        ...
        <div className={theme == 'dark' ? darkThemeClass : lightThemeClass}>
            <div className="grid h-full max-w-lg grid-cols-4 mx-auto font-medium">
                {/* home */}
                <a href="/" type="button" className="inline-flex flex-col items-center justify-center px-5 group">
                ...
                {/* projects */}
                <a href="/portfolio" type="button" className="inline-flex flex-col items-center justify-center px-5 group">
                    <svg fill="currentColor" className="w-5 h-5 mb-2" xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 448 512">
